...
train_sales_data = pd.read_csv('train_sales_data.csv', engine='python')
train_search_data = pd.read_csv('train_search_data.csv', engine='python')
train_user_reply_data = pd.read_csv('train_user_reply_data.csv', engine='python')
test = pd.read_csv('evaluation_public.csv', engine='python')
...
df_lgb.to_csv("res_by_lgb.csv", index=False)
